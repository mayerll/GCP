...
# Run the following commands to test whether we set up GKE successfully (Please input region, project ID and cluster name)
terraform init
terraform plan
terraform apply
...
#Get endpoints information for verifying the components set up by Terraform.
